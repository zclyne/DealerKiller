...
class Gmail:
    ...
    Args:
        ...
        token_file: The path of the auth credentials file (created on first
            call).
    ...
    @classmethod
    def from_credentials_file(cls, credentials_file: str) -> Gmail:
        with open(credentials_file, "r", encoding="utf-8") as json_file:
            config = json.load(json_file)
            return cls.from_credentials_config(config)
    ...
    def get_unread_inbox(
        ...
        return self.get_unread_messages(
            user_id, labels, query, attachments=attachments, max_results=max_results
        )
    ...
    def get_starred_messages(
        ...
        return self.get_messages(
            user_id, labels, query, attachments, include_spam_trash, max_results
        )
    ...
    def get_trash_messages(
        ...
        Args:
            ...
            attachments: accepted values are 'ignore' which completely
                ...
                downloads the attachment data to store locally. Default
                'reference'.
            max_results: the maximum number of messages returned.
        ...
        return self.get_messages(user_id, labels, query, attachments, True, max_results)
    ...
    def get_messages(
        ...
        try:
            ...
            if "messages" in response:  # ensure request was successful
                message_refs = response["messages"]
    ...
    def get_message_by_id(
        ...
        return self._build_message_from_ref(user_id, message_ref, attachments)
